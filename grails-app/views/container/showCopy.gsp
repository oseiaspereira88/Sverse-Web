...
<html>
    ...
    <body>
        ...
        <div id="show-container" class="content scaffold-show" role="main">
            ...
            <f:display bean="container" />
            <g:form resource="${this.container}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.container}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
