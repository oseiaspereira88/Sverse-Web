<div class="amigo">
    <g:if test="${solicitacoes.size() != null && solicitacoes.size()>0}">
        <div class="columns">
            <div id="bloco1" class="column col-4">
                <g:if test="${solicitacoes.size() > 0}">
                    <g:each status="i" var="amigo" in="${solicitacoes}">
                        <g:if test="${(i % 3) == 0}">
