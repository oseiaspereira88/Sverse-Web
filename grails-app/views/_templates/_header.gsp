...
<div style="z-index:2; float:left; border:0; margin-left: 4%; margin-top: 2%" class="popover popover-bottom">
  <div class="btn btn-primary chip mavatar" style="height: 48px; font-size: 14px;" onclick="function alternarMenu() {
      $('.menuconta').animate({height: 'toggle'});
  }">
    <asset:image class="avatar avatar-lg" alt="Oséias Pereira" src="perfil_sverse.png"/>
    Oséias Pereira
  </div>

  <div id="menuconta" class="card-body menuconta" style="z-index: 2; margin-top: 20px; margin-left: 160px;">
    <ul class="menu">
      <li class="menu-item">
      ...
      <li class="menu-item"><a href="#" onclick="window.location.href = '${request.contextPath}/logoff'">Sair</a></li>
    </ul>
  </div>
</div>
