...
background-size: cover; background-position: center center; background-repeat: no-repeat; margin: 0; padding: 0; height: 240px;">
    ...
    <asset:image style="position: absolute; border-radius: 50%; height: 60px; width: 60px; top: 32px; border-style: solid; border-color: whitesmoke; left: 40%" src="perfil_sverse.png"></asset:image>
    ...
    <div style="position:absolute; bottom: 4px; left: 24px;">
        <button style="background-color: #39c94b" id="btn" onclick="cronometro(1)" type="button"
                class="col-md-2 col-md-offset-5 btn btn-success">Iniciar</button>
        <button style="background-color: #39c94b" id="btnPause" onclick="parar()" type="button"
                class="hide col-md-2 col-md-offset-5 btn btn-danger">Pause</button>
        <button style="background-color: #39c94b" id="btnStop" onclick="stop()" type="button"
