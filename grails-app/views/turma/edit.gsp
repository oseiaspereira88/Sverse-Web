...
<html>
    ...
    <body>
        ...
        <div id="edit-turma" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.turma}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.turma}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.turma}" method="PUT">
                <g:hiddenField name="version" value="${this.turma?.version}" />
                <fieldset class="form">
                    <f:all bean="turma"/>
                </fieldset>
