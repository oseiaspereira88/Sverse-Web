...
<html>
    ...
    <body>
        ...
        <div id="show-turma" class="content scaffold-show" role="main">
            ...
            <f:display bean="turma" />
            <g:form resource="${this.turma}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.turma}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
