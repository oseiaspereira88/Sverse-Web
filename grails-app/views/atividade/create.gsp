...
<html>
    ...
    <body>
        <a href="#create-atividade" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-atividade" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.atividade}" method="POST">
                <fieldset class="form">
                    <f:all bean="atividade"/>
                </fieldset>
