...
<html>
    ...
    <body>
        ...
        <div id="show-atividade" class="content scaffold-show" role="main">
            ...
            <f:display bean="atividade" />
            <g:form resource="${this.atividade}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.atividade}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
