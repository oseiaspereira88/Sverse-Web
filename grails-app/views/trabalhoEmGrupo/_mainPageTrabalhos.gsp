...
<script>
    ...
    function openFormCreate() {
        ...
        if(divForm.style.display == "none"){
            divTrabalhos.style.display = "none";
            spanAdd.innerHTML = "<"
            bAdd.classList.remove("rotate")
            bAdd.classList.add("rotate");
            divForm.style.display = "block";
        }else {
            divTrabalhos.style.display = "block";
            spanAdd.innerHTML = "+"
            bAdd.classList.remove("rotate")
            bAdd.classList.add("rotate");
        ...
        <div class="conteudo" style="min-height: 60vh;">
            ...
            <div id="divForm"
                ...
                <g:form action='newTrabalho' method='POST' name='frmCreateTrabalho'>
                    ...
                    <g:textArea class="textarea" placeholder="Escreva a descrição do seu trabalho..." cols="30" rows="5"
                                name="descricao" form="frmCreateTrabalho"></g:textArea><br>
                    Previsão de Termino:
