...
<html>
    ...
    <body>
        ...
        <div id="show-objetivos" class="content scaffold-show" role="main">
            ...
            <f:display bean="objetivos" />
            <g:form resource="${this.objetivos}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.objetivos}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
